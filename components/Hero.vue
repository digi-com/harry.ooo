  ...
  <section id="hero">
    <client-only>
      <ProgressiveImage
        :width="1200"
        :height="1697"
        src="/meat-rack/meat-rack-poster.jpg"
        placeholder="/meat-rack/placeholders/meat-rack-poster.jpg"
        class="hero-image-1"
      />
      <ProgressiveImage
        :width="720"
        :height="576"
        src="/meat-rack/42.png"
      ...
      <ProgressiveImage
        :width="720"
        :height="576"
        src="/meat-rack/49.png"
        placeholder="/meat-rack/placeholders/49.png"
        class="hero-image-5"
      />
      <ProgressiveImage
        :width="720"
        :height="576"
        src="/meat-rack/11.png"
